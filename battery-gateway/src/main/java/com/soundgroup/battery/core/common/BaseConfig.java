...
public class BaseConfig {
    ...
    public static void init() {
        ...
        if (dir.exists()) {
           System.out.println("--> {} exists"+ DEFAULT_CONFIG_BASE_DIR);
        } else {
            if (dir.mkdirs()) {
                System.out.println("--> {} make it success"+DEFAULT_CONFIG_BASE_DIR);
            } else {
                System.out.println("--> {} make it failed"+DEFAULT_CONFIG_BASE_DIR);
            }
        }
        return ;
    }
