...
public class NativeLibraryLoader {
  ...
  File loadLibraryFromJarToTemp(final String tmpDir)
          throws IOException {
    final File temp = new File("/home/centin/ideaProject/net/cloud-rocksdb-master/rocksdb/librocksdbjni-linux64.so");
...
/*    try (
      ...
      getResourceAsStream("org/rocksdb/librocksdbjni-linux64.so")) {
      if (is == null) {
