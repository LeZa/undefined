...
public class ReceiveWatchMessages implements Process
{
        ...
        throws IllegalDataException
    {
        ...
        // try {
        // Location
        // location=(Location)Utils.wristwatchToPlatform(msg.getDataString()).get("location");
        // if(null!=location&&!"".equals(location)){
        // if(Constant.COMMAND_AL.equals(location.getOpType())){
        // //告警
        // String[] SNs=mac.split("\\*");
        // QueryMapServerImplService.getQueryMapServerImplPort().sendAlert(SNs[1],
        // location.getStatus());
        ...
        // LOG.info((new
        // StringBuilder()).append("全部位置上报=:").append(QueryMapEntity.getDataStr()).toString());
        // try{
        //
