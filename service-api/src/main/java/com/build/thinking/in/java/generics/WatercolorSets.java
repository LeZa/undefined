...
import com.build.thinking.in.java.generics.watercolors.*;
import java.util.*;
import static com.build.thinking.in.java.net.mindview.util.Print.*;
import static com.build.thinking.in.java.net.mindview.util.Sets.*;
import static com.build.thinking.in.java.generics.watercolors.Watercolors.*;
