package com.service.api.me.recycle;
...
//        String token = String.valueOf(loginMap.get("userToken"));
        String token = "b17c334e-a22d-49d5-8660-38a20b119734";
        final HttpPost httpPost = new HttpPost(ipAddress+"/sayHello");
        final HttpGet httpGet = new HttpGet(ipAddress+"/sayHello");

        final StringBody name = new StringBody("e0", ContentType.TEXT_PLAIN);
