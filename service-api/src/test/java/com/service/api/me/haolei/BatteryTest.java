...
public class BatteryTest {
    ...
    private final static String ipAddress="http://192.168.89.87:9154/open";
    ...
    public void selectByUid() throws Exception{
        ...
        NameValuePair nameValuePair1 = new BasicNameValuePair("SN","2170052369");
        NameValuePair nameValuePair2 = new BasicNameValuePair("CODE","HQ");
        parameters.add( nameValuePair1 );
        parameters.add( nameValuePair2 );
        final StringBody name = new StringBody("2170052369",ContentType.DEFAULT_TEXT);
        final StringBody CODE = new StringBody("HQ", ContentType.TEXT_PLAIN);
        final HttpEntity reqEntity = EntityBuilder.create().setParameters(parameters).build();
              /*  .addPart("SN", name)
                .addPart("CODE",CODE)
                .build();*/
        httpPost.setEntity( reqEntity );
